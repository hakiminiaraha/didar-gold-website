        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
          {collections.map((item) => (
            <article key={item.title} className="group relative h-[290px] overflow-hidden rounded-[24px]">
              <img src={item.image} alt={item.title} loading="lazy" decoding="async" width={420} height={290} className="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-105" />
